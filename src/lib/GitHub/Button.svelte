...
{#if clientId}
	<Button provider="GitHub" let:pxsz {texts} {type} {theme} {size} {text} {shape} {logo_alignment} {width} {locale} on:click={click}>
		<svg height={pxsz} width={pxsz} aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" class="octicon octicon-mark-github v-align-middle color-fg-default">
